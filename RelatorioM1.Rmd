...
kable(medidas_resumo_quantitativasA,
      digits = 2,
      caption = "Medidas resumo do N\\textordmasculine de matriculados, porcentagem de participação, notas de Lingua Portuguesa e Matemática, para a amostra de 50")
...
dados %>%
  ...
  geom_abline(slope = Dfit$coefficients[2], intercept = Dfit$coefficients[1], color = "black")
...
amostra %>%
  ggplot() +
  geom_point(aes(x = NOTA_LP, y = NOTA_MT), color= "#663399") +
  geom_abline(slope = Afit$coefficients[2], intercept = Afit$coefficients[1], color = "black")
