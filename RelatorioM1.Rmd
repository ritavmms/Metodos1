...
Metodos1<-readxl::read_xlsx("C:/Users/André/Downloads/Amostra_g04_Andre_Camila_Rita(1).xlsx")
...
Metodos1$TAM_MUN<- factor(Metodos1$TAM_MUN, levels = c(1, 2, 3, 4, 5), 
                          labels = c("<20000 hab", "20000 a 49999 hab", "50000 a 99999 hab",
                                     "100000 a 999999 hab", "1000000 ou mais"))
...
#### Objetivo 5
* Verificar se é possível afirmar que as notas em Língua Portuguesa e em Matemática são normalmente
distribuídas.
...
#### Objetivo 6
* Comparar a proficiência média em Matemática segundo o local da escola. A proficiência em
